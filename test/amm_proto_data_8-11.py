...
def main(var_name, input_file, output_file):
...
if __name__ == "__main__":
    main(var_name = "ffd", input_file = "nc/amm/primera_helada/ff_can.nc", output_file = "nc/amm/primera_helada/ff_8-11_can.nc")
    main(var_name = "ffd", input_file = "nc/amm/primera_helada/ff_pen.nc", output_file = "nc/amm/primera_helada/ff_8-11_pen.nc")