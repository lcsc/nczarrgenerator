...
netcdfs = [
    {'path': ['nc/mopredas/MOPREDAS_century_0-9.nc'], 'nc_var': 'p', 'var': 'pr', 'time_dim': 'time', 'ver_dim': 'lat', 'hor_dim': 'lon', 'nc_projection': 'EPSG:4326', 'calc_min_max': True, 'include_center_calc': True, 'chunk_shape': (5, 10, 16)},
]
