...
netcdfs = [
    {'path': ['nc/amm/primera_helada/ff_8-11_pen.nc', 'nc/amm/primera_helada/ff_8-11_can.nc'], 'nc_var': 'ffd', 'var': 'ffd', 'time_dim': 'time', 'ver_dim': 'lat', 'hor_dim': 'lon', 'nc_projection': 'EPSG:4326', 'calc_min_max': True, 'include_center_calc': True, 'chunk_shape': (5, 81, 113)},
]
