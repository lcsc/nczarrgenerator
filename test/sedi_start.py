...
netcdfs = [
    {'path': ['nc/sedi/SEDI_0-9.nc'], 'nc_var': 'SEDI', 'var': 'SEDI', 'time_dim': 'time', 'ver_dim': 'lat', 'hor_dim': 'lon', 'nc_projection': 'EPSG:4326', 'calc_min_max': False, 'include_center_calc': True, 'chunk_shape': (9, 90, 180)},
]
