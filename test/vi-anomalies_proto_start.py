...
nc_paths = [
    ...
    {'path': ['nc/vi-anomalies/kndvi_0-9.nc'], 'nc_var': 'KNDVI', 'var': 'KNDVI', 'time_dim': 'time', 'ver_dim': 'y', 'hor_dim': 'x', 'nc_projection': 'EPSG:23030', 'calc_min_max': True, 'include_center_calc': True, 'chunk_shape': (5, 52, 92)},
]
