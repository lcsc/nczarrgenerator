...
netcdfs = [
    {'path': ['nc/attm/mag_m0.3_pen.nc', 'nc/attm/mag_m0.3_can.nc'], 'nc_var': 'mag', 'var': 'mag_m0.3', 'time_dim': 'time', 'lat_dim': 'lat', 'lon_dim': 'lon', 'nc_projection': 'EPSG:4326', 'calc_min_max': False, 'include_center_calc': True, 'chunk_shape': (7, 81, 113)},
    {'path': ['nc/attm/deltamag_m0.3_pen.nc', 'nc/attm/deltamag_m0.3_can.nc'], 'nc_var': 'deltamag', 'var': 'deltamag_m0.3', 'time_dim': 'time', 'lat_dim': 'lat', 'lon_dim': 'lon', 'nc_projection': 'EPSG:4326', 'calc_min_max': False, 'include_center_calc': False, 'chunk_shape': (7, 81, 113)},
    {'path': ['nc/attm/mag_p0.9_pen.nc', 'nc/attm/mag_p0.9_can.nc'], 'nc_var': 'mag', 'var': 'mag_p0.9', 'time_dim': 'time', 'lat_dim': 'lat', 'lon_dim': 'lon', 'nc_projection': 'EPSG:4326', 'calc_min_max': False, 'include_center_calc': False, 'chunk_shape': (7, 81, 113)},
    {'path': ['nc/attm/deltamag_p0.9_pen.nc', 'nc/attm/deltamag_p0.9_can.nc'], 'nc_var': 'deltamag', 'var': 'deltamag_p0.9', 'time_dim': 'time', 'lat_dim': 'lat', 'lon_dim': 'lon', 'nc_projection': 'EPSG:4326', 'calc_min_max': False, 'include_center_calc': False, 'chunk_shape': (7, 81, 113)},
    {'path': ['nc/attm/mag_p1.5_pen.nc', 'nc/attm/mag_p1.5_can.nc'], 'nc_var': 'mag', 'var': 'mag_p1.5', 'time_dim': 'time', 'lat_dim': 'lat', 'lon_dim': 'lon', 'nc_projection': 'EPSG:4326', 'calc_min_max': False, 'include_center_calc': False, 'chunk_shape': (7, 81, 113)},
    {'path': ['nc/attm/deltamag_p1.5_pen.nc', 'nc/attm/deltamag_p1.5_can.nc'], 'nc_var': 'deltamag', 'var': 'deltamag_p1.5', 'time_dim': 'time', 'lat_dim': 'lat', 'lon_dim': 'lon', 'nc_projection': 'EPSG:4326', 'calc_min_max': False, 'include_center_calc': False, 'chunk_shape': (7, 81, 113)},
    {'path': ['nc/attm/mag_p2.0_pen.nc', 'nc/attm/mag_p2.0_can.nc'], 'nc_var': 'mag', 'var': 'mag_p2.0', 'time_dim': 'time', 'lat_dim': 'lat', 'lon_dim': 'lon', 'nc_projection': 'EPSG:4326', 'calc_min_max': False, 'include_center_calc': False, 'chunk_shape': (7, 81, 113)},
    {'path': ['nc/attm/deltamag_p2.0_pen.nc', 'nc/attm/deltamag_p2.0_can.nc'], 'nc_var': 'deltamag', 'var': 'deltamag_p2.0', 'time_dim': 'time', 'lat_dim': 'lat', 'lon_dim': 'lon', 'nc_projection': 'EPSG:4326', 'calc_min_max': False, 'include_center_calc': False, 'chunk_shape': (7, 81, 113)},
]
