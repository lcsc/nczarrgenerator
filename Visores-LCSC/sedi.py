...
# 229s sin max/min (ya que si se activan los máximos y mínimos aparece un error por ser la unidad de time 'months since...'); nczarrgenerator_all
# 224s sin max/min; nczarrgenerator
# 397s con max/min; nczarrgenerator