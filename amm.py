...
netcdfs = [
    {'path': ['nc/amm/primera_helada/ff_pen.nc', 'nc/amm/primera_helada/ff_can.nc'], 'nc_var': 'ffd', 'var': 'ffd', 'time_dim': 'time', 'ver_dim': 'lat', 'hor_dim': 'lon', 'nc_projection': 'EPSG:4326', 'calc_min_max': True, 'include_center_calc': True, 'chunk_shape': (31, 81, 113)},
    {'path': ['nc/amm/ultima_helada/lf_pen.nc', 'nc/amm/ultima_helada/lf_can.nc'], 'nc_var': 'lfd', 'var': 'lfd', 'time_dim': 'time', 'ver_dim': 'lat', 'hor_dim': 'lon', 'nc_projection': 'EPSG:4326', 'calc_min_max': True, 'include_center_calc': False, 'chunk_shape': (31, 81, 113)},
    {'path': ['nc/amm/acum_calor/gdd_corn_pen.nc', 'nc/amm/acum_calor/gdd_corn_can.nc'], 'nc_var': 'gdd', 'var': 'gdd_corn', 'time_dim': 'time', 'ver_dim': 'lat', 'hor_dim': 'lon', 'nc_projection': 'EPSG:4326', 'calc_min_max': True, 'include_center_calc': False, 'chunk_shape': (31, 81, 113)},
    {'path': ['nc/amm/acum_calor/gdd_wine_pen.nc', 'nc/amm/acum_calor/gdd_wine_can.nc'], 'nc_var': 'gdd', 'var': 'gdd_wine', 'time_dim': 'time', 'ver_dim': 'lat', 'hor_dim': 'lon', 'nc_projection': 'EPSG:4326', 'calc_min_max': True, 'include_center_calc': False, 'chunk_shape': (31, 81, 113)},
