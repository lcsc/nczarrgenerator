...
netcdfs = [
    {'path': ['nc/sedi/SEDI.nc'], 'nc_var': 'SEDI', 'var': 'sedi', 'time_dim': 'time', 'lat_dim': 'lat', 'lon_dim': 'lon', 'nc_projection': 'EPSG:4326', 'calc_min_max': False, 'include_center_calc': True, 'chunk_shape': (9, 90, 180)},
]
